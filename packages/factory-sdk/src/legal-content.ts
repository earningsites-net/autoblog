...
export function serializeLegalSectionsForEditing(sections: SharedLegalSection[]): string {
  return sections
    .flatMap((section) => {
...
export function buildDefaultLegalEditableText(kind: SharedLegalPageKind, context: SharedLegalContext): string {
  return serializeLegalSectionsForEditing(buildDefaultLegalPageContent(kind, context).sections);
}
